...
class TokenController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Token']))
		{
			...
			$model->token_id = Roaming::generate_uuid();
			$model->token_key = md5(uniqid($model->token_client_id, true));
			date_default_timezone_set("Asia/Jakarta");
			$model->token_create_date = date('Y-m-d h:i:s');
			$model->token_user_create = Yii::app()->user->id;
			if($model->save())
				$this->redirect(array('view','id'=>$model->token_id));
		}
