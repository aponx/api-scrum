...
class Priority extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('priority_id, priority_name', 'required'),
			array('priority_id', 'numerical', 'integerOnly'=>true),
			array('priority_name', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('priority_id, priority_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tikets' => array(self::HAS_MANY, 'Tiket', 'tiket_priority_id'),
		);
	}
